        ...
        <div class="row">
            <div class="col">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{route('admin.organisations.index',['select' => 'withTrashed'])}}" type="button"
                       class="btn btn-outline-secondary {{request()->get('select') == 'withTrashed'  ? 'active' : ''}}">Все</a>
                    <a href="{{route('admin.organisations.index',['select' =>'withoutTrashed'])}}" type="button"
                       class="btn btn-outline-secondary {{(request()->get('select') == 'withoutTrashed' || request()->get('select') == null)? 'active' : ''}}">Активные</a>
                    <a href="{{route('admin.organisations.index',['select' => 'trashed']) }}" type="button"
